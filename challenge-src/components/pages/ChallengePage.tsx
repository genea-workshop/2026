    ...
    <div className="space-y-12 text-brand-text-muted leading-relaxed">
      ...
      <section id="submission-tracks" className="text-justify">
        ...
        <div className="flex flex-col gap-4 mb-6">
          {[
            { track: 'Track 1', color: 'text-brand-primary bg-brand-primary/10', title: 'ECCV Workshop Submission', format: 'max 14-page submission to the Interactive Social Agents workshop, single-blind review, published in ECCV Workshop Proceedings.', desc: 'Intended for new systems or significant extensions of previously published systems.' },
            { track: 'Track 2', color: 'text-brand-secondary bg-brand-secondary/10', title: 'Extended Abstracts', format: 'max 7-page submission, single-blind review, non-archival', desc: 'For systems not yet ready for a full paper, enabling rapid dissemination of preliminary results and broader participation.' },
